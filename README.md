...
About
This is a RSVP bot for Whatsapp. It is able to record groups of people (and their attendees' number of pax) arriving to a particular event invited by the host. It makes it easier for the host to view at a glance:
...
Acknowlegements
This bot was built using whatsapp-web.js, and taking inspiration from SCSE iLAB: Create your own WhatsApp Chatbot workshop.
